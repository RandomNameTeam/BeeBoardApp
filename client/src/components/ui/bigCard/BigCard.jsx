...
const BigCard = ({ active, setActive, name, geo = 'Владивосток', tg = '', number = '8 999 000 00 00', date = '17 ноября', category = 'Сантехник', experience = '2-5 лет', title = 'Сантехник со стажем. Установка стальных смесителей, ремонт керамических поверхностей.', ...props }) => {
    return (
        <div className={moduleBigCard.card} onClick={() => setActive(false)}>
            <div className={ active ? "moduleBigCard.cardBox.active" : "moduleBigCard.cardBox"} onClick={e => e.stopPropagation()}>
                ...
                <div>
                    <h1 className={moduleBigCard.textBox}>
                        Фото
                    </h1>
                    <MyPhotoCircle />
                </div>
                <div className={moduleBigCard.linkBox}>
                    ...
                    <p>
                        <Link to='https://t.me/ka1danary' target="_blank" style={{ 'color': '#29B6F6', 'fontSize': '18px' }}>MihailSortir</Link>
                    </p>
                </div>
                <div>
